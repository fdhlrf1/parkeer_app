            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    if (isset($_GET['keyword'])) {
                        ...
                        $query_masuk = "SELECT * FROM tbpengendara_masuk WHERE id_parkir LIKE '%$keyword%' OR No_Polisi LIKE '%$keyword%' OR Merk LIKE '%$keyword%' OR Jenis LIKE '%$keyword%' OR Blok LIKE '%$keyword%' OR Jam_Masuk LIKE '%$keyword%'";
                        $result_masuk = mysqli_query($conn, $query_masuk);

                        // Query untuk mencari data berdasarkan keyword di tabel tbpengendara_keluar
                        $query_keluar = "SELECT * FROM tbpengendara_keluar WHERE No_Laporan LIKE '%$keyword%' OR id_parkir LIKE '%$keyword%' OR No_Polisi LIKE '%$keyword%' OR Merk LIKE '%$keyword%' OR Jenis LIKE '%$keyword%' OR Blok LIKE '%$keyword%' OR Jam_Masuk LIKE '%$keyword%' OR Jam_Keluar LIKE '%$keyword%' OR Tagihan LIKE '%$keyword%'";
