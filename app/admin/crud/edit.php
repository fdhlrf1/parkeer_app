...
<head>
    ...
    <title>Edit Petugas - Parkeer App</title>
                ...
                <div class="container ml-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold textjudultabel">Edit Petugas</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="aksi_edit.php" method="post">
                                    ...
                                    <div class="ml-5 mr-5">
                                        ...
                                        <input type="hidden" name="id" id="" value="<?php echo $pengguna['id'] ?>">
                                        <label for="Nama" class="form-label">Nama</label>
                                        <input type="text" name="nama" id="" class="form-control mb-1" value="<?php echo $pengguna['nama'] ?>">


                                        <label for="Username" class="form-label">Username</label>
                                        <input type="text" name="username" id="" class="form-control mb-1" value="<?php echo $pengguna['username'] ?>">

                                        <label for="Password" class="form-label">Password Baru</label>
                                        <input type="text" name="password" id="" class="form-control mb-1">
