...
<head>
    ...
    <title>Edit Kendaraan - Parkeer App</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="aksi_edit_kndmasuk.php" method="post">
                                    ...
                                    <div class="ml-5 mr-5">
                                        ...
                                        <select name="blok_sebelumnya" class="form-control mb-1">
