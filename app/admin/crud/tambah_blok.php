...
<head>
    ...
    <title>Tambah Blok - Parkeer App</title>
                ...
                <div class="container ml-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold textjudultabel">Tambah Blok</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="aksi_tambah_blok.php" method="post">
                                    ...
                                    <div class="ml-5 mr-5">
                                        ...
                                        <input type="text" name="blok" id="" class="form-control mb-1" placeholder="Masukkan nama Blok" required>


                                        <label for="TotalTempat" class="form-label">Total Tempat</label>
                                        <input type="number" name="totaltempat" id="" class="form-control mb-1" placeholder="Masukkan jumlah Total Tempat" min="1" required>
