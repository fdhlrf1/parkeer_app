...
$sql = "SELECT * FROM tbblok_parkir WHERE id_blok='$id_blok'";
$query = mysqli_query($conn, $sql);
$blok = mysqli_fetch_assoc($query);
...
<head>
    ...
    <title>Edit Blok - Parkeer App</title>
                ...
                <div class="container ml-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold textjudultabel">Edit Blok Parkir</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="aksi_edit_blok.php" method="post">
                                    ...
                                    <div class="ml-5 mr-5">
                                        ...
                                        <input type="hidden" name="id_blok" value="<?php echo $blok['id_blok'] ?>">

                                        <label for="Blok" class="form-label">Blok</label>
                                        <input type="text" name="blok" id="" class="form-control mb-1" placeholder="Masukkan nama Blok" value="<?php echo $blok['Blok'] ?>" required>


                                        <label for="TotalTempat" class="form-label">Total Tempat</label>
                                        <input type="number" name="totaltempat" id="" class="form-control mb-1" placeholder="Masukkan jumlah Total Tempat" value="<?php echo $blok['Total_Tempat'] ?>" min="1" required>
