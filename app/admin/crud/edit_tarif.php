...
if (!isset($_GET['id_tarif'])) {
    // kalau tid_tarifak ada id_tarif_parkir di query string
    // header('Location: form_pkeluar.php');
    error_reporting();
}

//ambil id_tarif_parkir dari query string
$id_tarif = $_GET['id_tarif'];

// buat query untuk ambil data dari database
$sql = "SELECT * FROM tbtarif_parkir WHERE id_tarif='$id_tarif'";
$query = mysqli_query($conn, $sql);
$tarif = mysqli_fetch_assoc($query);
...
<head>
    ...
    <title>Edit Tarif - Parkeer App</title>
                ...
                <div class="container ml-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold textjudultabel">Edit Tarif</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="aksi_edit_tarif.php" method="post">
                                    ...
                                    <div class="ml-5 mr-5">
                                        ...
                                        <input type="number" name="tarif" class="form-control mb-1" value="<?php echo $tarif['tarif'] ?>" min="1" required>
