...
<head>
    ...
    <title>Kelola Parkir - Parkeer App</title>
                ...
                <div class="container ml-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold textjudultabel">Kelola Laporan Parkir</h6>
                        </div>
                        <div class="card-body">
                            <h5 class="judul mb-3">Kelola Laporan Parkir Per Bulan</h5>

                            <!-- Form input untuk tanggal -->

                            <form id="sortirForm" action="aksi_kelola_laporan.php" method="GET">
                                <div class="d-flex align-items-center">

                                    <div class="form-group flex-fill me-3">
                                        <label for="daritanggal" class="form-label">Dari Tanggal:</label>
                                        <input type="date" id="daritanggal" name="daritanggal" class="form-control" required>
                                    </div>

                                    <div class="form-group flex-fill me-3">
                                        <label for="sampaitanggal" class="form-label">Sampai Tanggal:</label>
                                        <input type="date" id="sampaitanggal" name="sampaitanggal" class="form-control" required>
                                    </div>



                                </div>
                                <button type="submit" class="btn btn-success mt-1">Sortir</button>
